...
declare namespace createjs {
  ...
  class Graphics {
    ...
    drawRoundRect(x: number, y: number, w: number, h: number, r1: number, r2: number, r3: number, r4: number): Graphics;
...
declare namespace keyboardJS {
  function on(keys: string | string[], pressHandler: (e: KeyboardJSEvent) => void, releaseHandler?: (e?: KeyboardJSEvent) => void): void;
  function pause(): void;
...
declare namespace google {
  ...
  namespace picker {
    enum ViewId { DOCS }
    enum Action { PICKED }
    enum Response { ACTION, DOCUMENTS }
    enum Document { ID }
    enum DocsViewMode { LIST }
